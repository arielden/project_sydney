...
('What is 25% of 80?', '[{"id": "A", "text": "15"}, {"id": "B", "text": "20"}, {"id": "C", "text": "25"}, {"id": "D", "text": "30"}]', 'B', '25% of 80 = 0.25 × 80 = 20.', 300, false),

('What is the area of a rectangle with length 8 and width 6?', '[{"id": "A", "text": "14"}, {"id": "B", "text": "28"}, {"id": "C", "text": "48"}, {"id": "D", "text": "56"}]', 'C', 'Area of rectangle = length × width = 8 × 6 = 48.', 320, false),

('What is 2/3 + 1/6?', '[{"id": "A", "text": "3/9"}, {"id": "B", "text": "3/6"}, {"id": "C", "text": "4/6"}, {"id": "D", "text": "5/6"}]', 'D', 'Convert to common denominator: 2/3 = 4/6, so 4/6 + 1/6 = 5/6.', 380, true),

('What is 2³?', '[{"id": "A", "text": "6"}, {"id": "B", "text": "8"}, {"id": "C", "text": "9"}, {"id": "D", "text": "12"}]', 'B', '2³ = 2 × 2 × 2 = 8.', 310, false),

('What is the slope of the line passing through points (2, 3) and (6, 7)?', '[{"id": "A", "text": "1"}, {"id": "B", "text": "2"}, {"id": "C", "text": "1/2"}, {"id": "D", "text": "4"}]', 'A', 'Slope = (y₂ - y₁)/(x₂ - x₁) = (7 - 3)/(6 - 2) = 4/4 = 1.', 330, true),

-- Medium Level Questions (400-600 range)
('If x² - 5x + 6 = 0, what are the possible values of x?', '[{"id": "A", "text": "x = 2 or x = 3"}, {"id": "B", "text": "x = 1 or x = 6"}, {"id": "C", "text": "x = -2 or x = -3"}, {"id": "D", "text": "x = 2 or x = -3"}]', 'A', 'Factor: (x - 2)(x - 3) = 0, so x = 2 or x = 3.', 580, true),

('If 2x + y = 8 and x - y = 1, what is the value of x?', '[{"id": "A", "text": "2"}, {"id": "B", "text": "3"}, {"id": "C", "text": "4"}, {"id": "D", "text": "5"}]', 'B', 'Add the equations: 3x = 9, so x = 3.', 620, true),

('If f(x) = 2x + 3, what is f(4)?', '[{"id": "A", "text": "8"}, {"id": "B", "text": "11"}, {"id": "C", "text": "14"}, {"id": "D", "text": "17"}]', 'B', 'f(4) = 2(4) + 3 = 8 + 3 = 11.', 550, false),

('What is the circumference of a circle with radius 5? (Use π = 3.14)', '[{"id": "A", "text": "15.7"}, {"id": "B", "text": "31.4"}, {"id": "C", "text": "78.5"}, {"id": "D", "text": "157"}]', 'B', 'Circumference = 2πr = 2 × 3.14 × 5 = 31.4.', 600, false),

('Solve for x: 3x - 7 > 8', '[{"id": "A", "text": "x > 5"}, {"id": "B", "text": "x > 15/3"}, {"id": "C", "text": "x > 1/3"}, {"id": "D", "text": "x > 15"}]', 'A', '3x - 7 > 8, so 3x > 15, therefore x > 5.', 560, true),

('What is the probability of rolling a 4 on a standard six-sided die?', '[{"id": "A", "text": "1/4"}, {"id": "B", "text": "1/6"}, {"id": "C", "text": "1/3"}, {"id": "D", "text": "2/3"}]', 'B', 'There is 1 favorable outcome out of 6 possible outcomes: 1/6.', 520, false),

('If 3/4 = x/12, what is x?', '[{"id": "A", "text": "8"}, {"id": "B", "text": "9"}, {"id": "C", "text": "10"}, {"id": "D", "text": "16"}]', 'B', 'Cross multiply: 3 × 12 = 4 × x, so 36 = 4x, x = 9.', 540, false),

('Solve |x - 3| = 5', '[{"id": "A", "text": "x = 8 only"}, {"id": "B", "text": "x = -2 only"}, {"id": "C", "text": "x = 8 or x = -2"}, {"id": "D", "text": "x = 2 or x = 8"}]', 'C', 'x - 3 = 5 or x - 3 = -5, so x = 8 or x = -2.', 650, true),

('Sarah has 3 times as many books as Tom. Together they have 24 books. How many books does Sarah have?', '[{"id": "A", "text": "6"}, {"id": "B", "text": "12"}, {"id": "C", "text": "18"}, {"id": "D", "text": "21"}]', 'C', 'Let Tom have x books. Sarah has 3x. Total: x + 3x = 24, so 4x = 24, x = 6. Sarah has 3(6) = 18.', 680, false),

('The median of the dataset {2, 5, 7, x, 12} is 7. What is x?', '[{"id": "A", "text": "7"}, {"id": "B", "text": "8"}, {"id": "C", "text": "9"}, {"id": "D", "text": "10"}]', 'A', 'For median to be 7, x must be 7 (so the middle value in the ordered set is 7).', 610, true),

('What is the distance between points (1, 2) and (4, 6)?', '[{"id": "A", "text": "3"}, {"id": "B", "text": "4"}, {"id": "C", "text": "5"}, {"id": "D", "text": "7"}]', 'C', 'Distance = √[(4-1)² + (6-2)²] = √[9 + 16] = √25 = 5.', 670, false),

('A price increases from $40 to $50. What is the percent increase?', '[{"id": "A", "text": "10%"}, {"id": "B", "text": "20%"}, {"id": "C", "text": "25%"}, {"id": "D", "text": "125%"}]', 'C', 'Percent increase = (50-40)/40 × 100% = 10/40 × 100% = 25%.', 570, false),

('Express 0.00045 in scientific notation', '[{"id": "A", "text": "4.5 × 10⁻⁴"}, {"id": "B", "text": "45 × 10⁻⁵"}, {"id": "C", "text": "4.5 × 10⁻³"}, {"id": "D", "text": "0.45 × 10⁻³"}]', 'A', 'Move decimal point 4 places right: 0.00045 = 4.5 × 10⁻⁴.', 530, false),

-- Hard Level Questions (600-750 range)
('If g(x) = x² - 4x + 3 and h(x) = x + 1, what is g(h(2))?', '[{"id": "A", "text": "0"}, {"id": "B", "text": "3"}, {"id": "C", "text": "6"}, {"id": "D", "text": "12"}]', 'A', 'h(2) = 2 + 1 = 3. Then g(3) = 3² - 4(3) + 3 = 9 - 12 + 3 = 0.', 720, true),

('A population doubles every 3 years. If the initial population is 100, what will it be after 9 years?', '[{"id": "A", "text": "300"}, {"id": "B", "text": "600"}, {"id": "C", "text": "800"}, {"id": "D", "text": "900"}]', 'C', 'After 9 years (3 doubling periods): 100 × 2³ = 100 × 8 = 800.', 780, true),

('In a right triangle, one leg is 3 and the hypotenuse is 5. What is the length of the other leg?', '[{"id": "A", "text": "2"}, {"id": "B", "text": "4"}, {"id": "C", "text": "6"}, {"id": "D", "text": "8"}]', 'B', 'Using Pythagorean theorem: a² + 3² = 5², so a² + 9 = 25, a² = 16, a = 4.', 750, false),

('Factor completely: x³ - 8', '[{"id": "A", "text": "(x - 2)(x² + 2x + 4)"}, {"id": "B", "text": "(x - 2)(x + 2)²"}, {"id": "C", "text": "(x - 2)³"}, {"id": "D", "text": "(x + 2)(x² - 2x + 4)"}]', 'A', 'This is difference of cubes: x³ - 8 = x³ - 2³ = (x - 2)(x² + 2x + 4).', 800, true),

('The mean of 5 numbers is 12. If four of the numbers are 10, 11, 13, and 15, what is the fifth number?', '[{"id": "A", "text": "9"}, {"id": "B", "text": "11"}, {"id": "C", "text": "13"}, {"id": "D", "text": "15"}]', 'B', 'Sum = 5 × 12 = 60. Sum of four numbers = 49. Fifth number = 60 - 49 = 11.', 730, false),

-- Very Hard Level Questions (750-800 range)
('If log₂(x) = 3, what is x?', '[{"id": "A", "text": "6"}, {"id": "B", "text": "8"}, {"id": "C", "text": "9"}, {"id": "D", "text": "16"}]', 'B', 'log₂(x) = 3 means 2³ = x, so x = 8.', 800, true),

('A circle has center (2, 3) and radius 4. Which point lies on the circle?', '[{"id": "A", "text": "(6, 3)"}, {"id": "B", "text": "(2, 7)"}, {"id": "C", "text": "(5, 6)"}, {"id": "D", "text": "(6, 6)"}]', 'A', 'Distance from center (2,3) to (6,3) is |6-2| = 4, which equals the radius.', 780, true),

('If (x + 2)² = 25, what are all possible values of x?', '[{"id": "A", "text": "x = 3 only"}, {"id": "B", "text": "x = -7 only"}, {"id": "C", "text": "x = 3 or x = -7"}, {"id": "D", "text": "x = 5 or x = -5"}]', 'C', 'Taking square root: x + 2 = ±5, so x = 3 or x = -7.', 790, false),

('Simplify: (x² - 4)/(x + 2)', '[{"id": "A", "text": "x - 2"}, {"id": "B", "text": "x + 2"}, {"id": "C", "text": "(x - 2)²"}, {"id": "D", "text": "x² - 2"}]', 'A', 'Factor numerator: (x² - 4) = (x - 2)(x + 2). Cancel (x + 2): result is x - 2.', 800, true),

('In an arithmetic sequence, the first term is 3 and the common difference is 4. What is the 10th term?', '[{"id": "A", "text": "37"}, {"id": "B", "text": "39"}, {"id": "C", "text": "41"}, {"id": "D", "text": "43"}]', 'B', 'Formula: aₙ = a₁ + (n-1)d = 3 + (10-1)×4 = 3 + 36 = 39.', 795, false);
